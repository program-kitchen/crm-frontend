      ...
      <div class="main-cource">
        ...
        <table class="main-cource-term__table">
          ...
          >
            ...
            <td>
              <button
                class="main-cource-term__table-data-button--edit"
            ...
            <td>
              <button
                class="main-cource-term__table-data-button--delete"
        ...
        <button class="main-cource__button-auth" @click="newCourceRegist">登録</button>
...
.main-cource-term__table-data-button--edit,
.main-cource-term__table-data-button--delete {
  border: none;
  border-radius: 20px;
  color: #FFFFFF;
  padding: 0 0.7rem;
...
.main-cource-term__table-data-button--edit:hover,
.main-cource-term__table-data-button--delete:hover {
  cursor: pointer;
  transition:  0.5s;
}

.main-cource-term__table-data-button--edit p,
.main-cource-term__table-data-button--delete p {
